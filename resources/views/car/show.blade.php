                ...
                <div class="car-images-and-description">
                    ...
                    <div class="card car-detailed-description">
                        ...
                        <ul class="car-specifications">
                            <x-car-features :carFeatures="$car->features->air_conditioning">
                                Air Conditioning
                            </x-car-features>
                            <x-car-features :carFeatures="$car->features->cruise_control">
                                Cruise Control
                            </x-car-features>
                            <x-car-features :carFeatures="$car->features->power_windows">
                                Power Windows
                            </x-car-features>
                            <x-car-features :carFeatures="$car->features->power_door_locks">
                                Power Door Locks
                            </x-car-features>
                            <x-car-features :carFeatures="$car->features->abs">
                                ABS
                            </x-car-features>
                            <x-car-features :carFeatures="$car->features->bluetooth_connectivity">
                                Bluetooth Connectivity
                            </x-car-features>
                            <x-car-features :carFeatures="$car->features->remote_start">
                                Remote Start
                            </x-car-features>
                            <x-car-features :carFeatures="$car->features->gps_navigation_system">
                                GPS Navigation System
                            </x-car-features>
                            <x-car-features :carFeatures="$car->features->heated_seats">
                                Heated Seats
                            </x-car-features>
                            <x-car-features :carFeatures="$car->features->climate_control">
                                Climate Control
                            </x-car-features>
                            <x-car-features :carFeatures="$car->features->rear_parking_sensors">
                                Rear Parking Sensors
                            </x-car-features>
                            <x-car-features :carFeatures="$car->features->leather_seats">
                                Leather Seats
                            </x-car-features>
                        </ul>
                    </div>
                ...
                <div class="car-details card">
                    <div class="flex items-center justify-between">
                        ...
                        <button class="btn-heart" data-url="{{ route('watchlist.storeDestroy', $car) }}">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#e9580c"
                                style="width: 20px" @class([
                                    'hidden' => !$car->favouredUsers->contains(
                    ...
                    <div class="phone-container d-flex align-items-center">
                        ...
                        <button class="car-details-phone-view">view full number</button>
                    </div>
